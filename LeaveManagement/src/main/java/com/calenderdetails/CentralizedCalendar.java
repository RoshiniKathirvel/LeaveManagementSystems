...
public class CentralizedCalendar extends LeaveInformation {
    ...
    private List<LeaveInformation> initializePredefinedHolidays() {
        ...
        holidays.add(new LeaveInformation(2,"Pongal", "Harvest festival celebrated in South India", 1, createDate(2024, 0, 15)));
        holidays.add(new LeaveInformation(3,"Republic Day", "Public holiday to celebrate the Republic Day", 1, createDate(2024, 0, 26)));
        holidays.add(new LeaveInformation(4,"Ugadi", "Ugadi is a Telugu and Kannada New Year festival", 1, createDate(2024, 3, 9)));
        holidays.add(new LeaveInformation(5,"Ramzan", "Ramzan is a Muslim Festival", 1, createDate(2024, 3, 11)));
        holidays.add(new LeaveInformation(6,"May Day", "A celebration of labor and the working class", 1, createDate(2024, 4, 1)));
        ...
        holidays.add(new LeaveInformation(9,"Ayudha Pooja", "Ayudha Pooja is a Hindu festival celebrated on the ninth day of Navaratri", 1, createDate(2024, 9, 11)));
        holidays.add(new LeaveInformation(10,"Diwali", "It symbolizes the victory of light over darkness and good over evil.", 1, createDate(2024, 9, 31)));
        holidays.add(new LeaveInformation(11,"Laxmi Pojan", "the goddess of wealth and prosperity. It is a part of the Diwali celebrations.", 1, createDate(2024, 10, 1)));
    ...
    public static void displayLeaveCalendar() {
        for (LeaveInformation holiday : predefinedHolidays) {
            System.out.println("Leave Type ID: " + holiday.getLeaveTypeId());
            System.out.println("Leave Name: " + holiday.getLeaveName());
            System.out.println("Leave Description: " + holiday.getLeaveDescription());
            System.out.println("No. of Days Allowed: " + holiday.getNoOfDaysAllowed());

            // Display holiday dates using SimpleDateFormat
            SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
            System.out.println("--------------------------------------------------------------------");
            System.out.println("Holiday Date: " + dateFormat.format(holiday.getHolidayDates().get(0)));
